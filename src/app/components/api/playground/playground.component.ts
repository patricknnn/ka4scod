...
export class PlaygroundComponent implements OnInit {
    ...
    getLifetimeStats(): void {
        this.api
            .getLifetimeStats(this.player)
            .then((result) => (this.resultContent = JSON.stringify(result)));
        this.resultTitle = 'Lifetime stats';
    }

    getWarzoneStats(): void {
        this.api
            .getWarzoneStats(this.player)
            .then((result) => (this.resultContent = JSON.stringify(result)));
    ...
    getBattlePassTiers(): void {
        this.api
            .getBattlePassTiers(this.season, this.player.platform)
            .then((result) => (this.resultContent = JSON.stringify(result)));
