    ...
    getLifetimeData(): void {
        ...
        this.api
            ...
            .then((res: LifetimeStats) => {
                ...
                this.shotsFired =
                    res.lifetime.accoladeData.properties.shotsFired;
                this.hours = this.secondsToHms(
                    res.lifetime.all.properties.timePlayedTotal
                );
                ...
                this.sdHours = this.secondsToHms(
                    res.lifetime.mode.sd.properties.timePlayed
                );
                ...
                this.sdScoreMin =
                    res.lifetime.mode.sd.properties.scorePerMinute;
            })
            .catch((error) => {
